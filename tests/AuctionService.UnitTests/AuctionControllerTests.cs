...
public class AuctionControllerTests
{
    ...
    [Fact]
    public async Task GetAuctionById_WithValidCreatAuctionDto_ReturnsCreatedAtAction()
    {
        // arrange
        var auction = _fixture.Create<CreationAuctionDto>();
    ...
    {
        // arrange
        var auctionDto = _fixture.Create<CreationAuctionDto>();
        _auctionRepo.Setup(repo => repo.AddAuction(It.IsAny<Auction>()));
